...
```
Sonnet4.6(high) Ctx:▰▰▱▱▱40% Cost:▰▰▱▱▱(¥67 Today:¥200/¥500) Acct:▰▱▱▱▱15%
```

API key user, over daily budget:

```
!!Opus4.8(high) Ctx:▰▰▰▱▱60% Cost:!!▰▰▰▰▰(¥200 Today:¥510/¥500) Acct:▰▰▰▱▱55%
```
...
| `Cost:▰▱▱▱▱(¥XXX Today:¥XXX/¥500)` | Current session cost and daily total in JPY with budget bar |
